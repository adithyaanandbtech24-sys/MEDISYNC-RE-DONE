...
class MedicalStandardProvider {
    ...
    private var fastingGlucoseRange: StandardRange {
        // ICMR Guidelines: Normal < 100 mg/dL (100-125 is Prediabetes)
    ...
    private var postPrandialGlucoseRange: StandardRange {
        // ICMR Guidelines: Normal < 140 mg/dL (140-199 is Impaired Glucose Tolerance)
         StandardRange(min: 90, max: 140, unit: "mg/dL", description: "Normal PPBS", severity: .normal)
    }
